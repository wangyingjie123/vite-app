import { Input, InputNumber, AutoComplete, Checkbox, Radio, Switch, Rate, Slider, Upload, type InputProps } from 'antd';
...
import { BaseDatePicker, BaseRangePicker, BaseTimePicker, BaseTimeRangePicker } from '@/components/Dates';
...
export function getComponent(t: TFunction, item: FormList, onPressEnter: () => void) {
  ...
  // 输入框渲染
  const renderInput = (
    <Input {...(initCompProps(t, 'Input', onPressEnter) as InputProps)} {...(componentProps as InputProps)} />
  );
